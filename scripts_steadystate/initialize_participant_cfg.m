function [cfg] = initialize_participant_cfg(participant, ICA)
    if nargin < 3
        ICA = false;
    end
    ...
    cfg.datadir_processed       = [cfg.rootdir 'steadystate' filesep];
    cfg.subjectdir              = [cfg.datadir cfg.subjectnr filesep];
    cfg.subjectdir_processed    = [cfg.rootdir 'steadystate/' cfg.subjectnr filesep];
